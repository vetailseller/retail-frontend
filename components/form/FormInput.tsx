          ...
          <div className={cn("rt-w-full", className)}>
            ...
            <div className="rt-relative rt-mt-2">
              ...
              <Input
                ...
                className={cn(
                  "rt-hide-number-stepper rt-peer rt-w-full rt-rounded-10 rt-border rt-border-input rt-bg-white rt-px-4 rt-py-[12px] rt-text-base rt-shadow-sm rt-transition-all rt-h-[46px]",
                  "placeholder:rt-text-muted",
                  "focus-visible:rt-outline-none focus-visible:rt-ring-1 focus-visible:rt-ring-ring focus-visible:rt-ring-0",
                  "disabled:rt-cursor-not-allowed disabled:rt-opacity-50",
                  errorMessage &&
                    "rt-border-destructive focus-visible:rt-ring-destructive",
                  startIcon && "rt-pl-10",
